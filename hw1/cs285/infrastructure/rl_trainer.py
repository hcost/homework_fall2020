...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        # ODO decide whether to load training data or use the current policy to collect more data
        ...
        # ODO collect `batch_size` samples to be used for training
        ...
        if self.log_video:
            ...
            ## ODO look in utils and implement sample_n_trajectories
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            # ODO sample some data from the data buffer
            # HINT1: use the agent's sample function
            # HINT2: how much data = self.params['train_batch_size']
            ob_batch, ac_batch, re_batch, next_ob_batch, terminal_batch = self.agent.sample(self.params['train_batch_size'])

            # ODO use the sampled data to train an agent
